            ...
            <div className="bg-testimonial pt-40 pb-32 lg:py-32" id="testimonial-section">
                <div className='mx-auto max-w-7xl sm:py-4 lg:px-8 '>
                    ...
                    <div className="text-center">
                        <h3 className="text-3xl sm:text-5xl font-bold text-black dark:text-white my-3">See what others are saying.</h3>
                        ...
                        {postData.map((items, i) => (
                            <div key={i} className="relative">
                                <div className='bg-white test-sha m-3 p-10 my-20 rounded-3xl'>
                                    ...
                                    <h4 className='text-base font-medium text-testColor dark:text-black my-4'>{items.comment}</h4>
                                    <hr style={{ color: "lightgrey" }} />
                                    <div className="flex justify-between">
                                        <div>
                                            <h3 className='text-base font-medium pt-4 pb-2 dark:text-black'>{items.name}</h3>
                                            <h3 className='text-xs font-medium  pb-2 opacity-50 dark:text-black'>{items.profession}</h3>
                                        </div>
                                        <div className="flex">
